...
## Corpus Check
- 52 files · ~3,484,673 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 257 nodes · 292 edges · 27 communities (15 shown, 12 thin omitted)
...
- `GlassNavbar()` --calls--> `cn()`  [EXTRACTED]
  components/sections/navbar.tsx → lib/utils.ts
...
### Community 1 - "cn"
Cohesion: 0.09
Nodes (19): metadata, montserrat, playfair, RootLayout(), BentoCard(), BentoGrid(), BorderBeam(), BorderBeamProps (+11 more)
...
- **Why does `cn()` connect `cn` to `navbar.tsx`?**
